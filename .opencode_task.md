...
## Objective
Improve `src/stitching/editable/candidate_current.py` to reduce aggregate RMS.

## Current Metrics
- Current aggregate RMS: 9.978082108639569
- Best achieved RMS: 0.10416468086483141
- Iteration: 4

## ⚠️ Previous Attempt Failed
Error: ERROR: Remove ALL 'copy=False' from np.array() calls. Use np.array(arr) instead.
Try a DIFFERENT approach this time.

## Previous Iteration Was Rejected
REJECTED (rejected_crash): Use least-squares estimation of piston/tip/tilt errors via overlap analysis | Errors: error: ValueError: operands could not be broadcast together with shapes (128,128) (11836,) 

CRASH at line 99 in candidate_current.py
```python
   1:                             z_mean = 
...
## Domain Notes
# TASK: Reduce RMS on ('s17_highres_circular',)

## Current: RMS=9.978082 | Best=0.104165
✗ s17_highres_circular: RMS=9.978082

## STRATEGY (iter 4):
STEP 5: Try overlap-weighted mean or local averaging.
