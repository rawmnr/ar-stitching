function [CarteSortie,a]=LegendreSub(carteEntree,vec,OrdreAnalyse)
%Fonction SCR
...
CarteSortie.titre=strcat(carteEntree.titre,'_SubL');
%'keep' les n premiers Zernike
CarteSortie.carte(pup)=CarteSortie.carte(pup)-L(:,idx)*a(idx);
