...
function CarteHFGenere=GenerateurCartesHF(HVHFLevel,resolution, rayon, main_folder)

repertoire_source=[main_folder '\EXP1000_sources\HF_EXP1000'];
mirroirs=[3,5];
...
for i=mirroirs
    ...
    switch i
        case 1
            fid=fopen([repertoire_source '\FLAT1200.opd']);
        case 2
