...
function CarteHFGenere=GenerateurCartesHF_IRIDE(HVHFLevel,resolution, mirroirs, main_folder)
...
for i=mirroirs
    ...
    switch i
        case 1
            fid=fopen([repertoire_source 'HF_EXP1000_IRIDE\COAST1500_FMA1_PH70.Opd']);
        case 2
            fid=fopen([repertoire_source 'HF_EXP1000_IRIDE\COAST1500_FMA1_PH73.Opd']);
        case 3
            fid=fopen([repertoire_source 'NOISE_IRIDE\COAST1500_ODLfail.Opd']);

        case 4
            fid=fopen([repertoire_source 'NOISE_IRIDE\COAST1500_ODLfail2.Opd']);
        case 5
...
arraysize = size(map,1);
RealPart=zeros(arraysize,arraysize);
ImPart=zeros(arraysize,arraysize);
RealPart_STD=zeros(arraysize,arraysize);
ImPart_STD=zeros(arraysize,arraysize);
...
for i=mirroirs
    ...
    switch i
        case 1
            fid=fopen([repertoire_source '\COAST1500_FMA1_PH70.Opd']);
        case 2
            fid=fopen([repertoire_source '\COAST1500_FMA1_PH73.Opd']);
        case 3
