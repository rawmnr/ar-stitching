...
function carteGen=cartesSimulees_IRIDE(resolution,Rpupille, lambda, repertoire_cartes, nom_carte, CoefBF, HF_YesNo, HVHFlevel, LMFLevel, main_folder)
...
%Generation des HVHF
if HF_YesNo
    CarteHVHF=GenerateurCartesHF_IRIDE(HVHFlevel,resolution, [1,2], main_folder);
else
